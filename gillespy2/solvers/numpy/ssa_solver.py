...
class MaxStateReached(Exception):
    pass
...
class NumPySSASolver(GillesPySolver):
    ...
    @staticmethod
    def run(model, t=20, number_of_trajectories=1, increment=0.05, seed=None, debug=False, show_labels=True, max_state=None, **kwargs):
        """
        ...
        for trajectory_num in range(number_of_trajectories):
            ...
            while entry_count < timeline.size:
                #Event: current_state overides max_state.
                #Action: terminate
